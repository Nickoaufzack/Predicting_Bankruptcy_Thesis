...
indicate that the separation between healthy and bankrupt firms seems to be not purely linear. They
...
\begin{table}[htbp]
  \centering
  \caption{Selected hyperparameters on highest fold-averaged $F_2$.}
  \label{tab:selected}
  \begin{tabular}{l|l|l}
    \toprule
...
The full search spaces can be seen in Appendix~\ref{sec:app-grids}. 
...
rankings, with the Debt ratio standing clearly above the rest in both. That
